  ...
  return (
    <section className="productHome-section mx-auto mt-[60px] md:mt-[150px]">
      <div className="productHome-content">
        <h1 className="text-2xl sm:text-3xl md:text-[32px] font-semibold mb-4 md:mb-5 text-strong-blue leading-8 sm:leading-10 md:leading-[40px]">Equipos destacados para vender, producir y escalar mejor</h1>
        <p className="productHome-text max-w-3xl mx-auto text-[17px] leading-7 text-slate-600">
          Descubre soluciones listas para impresión textil, gran formato, personalización y producción comercial con respaldo de Siscoprint.
        </p>
      </div>
